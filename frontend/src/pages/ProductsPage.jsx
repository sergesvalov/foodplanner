        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          ...
          <div className="relative w-full md:w-64">
            <input
              ...
              className="w-full pl-3 pr-8 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 outline-none transition-shadow"
              value={searchTerm}
